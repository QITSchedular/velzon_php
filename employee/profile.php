    ...
    <div class="main">
        <div class="profile-foreground position-relative mx-n4 mt-n4">
            <div class="profile-wid-bg">
                <img class="profile-wid-img" id="loadbginprofile" src="../assets/images/auth-one-bg.jpg"/>
            </div>
        </div>
        ...
        <div class="pt-2 mb-2 mb-lg-2 pb-lg-3 mt-2">
            <div class="row g-4">
                <div class="col-auto">
                    <div class="avatar-xl">
                        <img src="../assets/images/users/user-dummy-img.jpg" id="pictureInProfileHeading" class="img-thumbnail rounded-circle h-100 w-100" />
                    </div>
                </div><br>
                <!--end col-->
                <div class="col">
            ...
            <div class="col-lg-12 pb-3">
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="edit-profile" class="btn btn-success" id="editProfileBtn"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                    </div>
                </div>
            </div>
        </div>
