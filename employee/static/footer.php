...
<div class="customizer-setting d-none d-md-block" data-bs-toggle="tooltip" title="Give suggestions">
    <div class="btn-info btn-rounded shadow-lg btn btn-icon btn-lg p-2" data-bs-toggle="modal" data-bs-target="#flipModal">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" id="id" name="id" value="<?php echo $_SESSION['emp_code']; ?>" hidden>
                            </div>
                            <textarea class="form-control" id="suggestion_body" name="suggestion_body" rows="5"></textarea>
                        </div>
                    </div>
                </div>
                <div class="text-center mb-3">
                    <input type="submit" class="btn btn-primary" id="suggestion" value="MAKE A SUGGESSTION" data-bs-dismiss="modal" aria-label="Close">
                </div>
            </form>
        </div>
    </div><!-- /.modal-dialog -->
...
<script src="../assets/javascript/employee_main.js"></script>
...
<!-- <script src="../assets/js/pages/bootstrap.js"></script> -->
...
<script src="../assets/js/pages/gridjs1.init.js"></script>
